...
class __$$RemoveOrderImplCopyWithImpl<$Res>
    extends _$CheckoutEventCopyWithImpl<$Res, _$RemoveOrderImpl>
...
class _$RemoveOrderImpl implements _RemoveOrder {
  const _$RemoveOrderImpl(this.product);
  ...
  @override
  String toString() {
    return 'CheckoutEvent.removeOrder(product: $product)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return removeOrder?.call(product);
  }
...
abstract class _RemoveOrder implements CheckoutEvent {
  const factory _RemoveOrder(final Product product) = _$RemoveOrderImpl;
